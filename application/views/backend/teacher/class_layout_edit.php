				...
				?>
					...
					<tbody class="add_student_body">
					  ...
					  ?>
						  ...
						  <div stuid="<?php echo $student_id;?>" class="add_student_cover filled_places_edit">
					  ...
					  <?php 
					     ...
					     <td>
						  <div stuid="" class="add_student_cover">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
		...
		<!--<form action="<?php echo site_url('teacher/class_layout_change/');?>" method="POST" name="student_list" id="student_list">-->
	...
	<?php	} ?>
		  ...
		  <input type="submit" name="stu_frm" class="btn btn-primary stud_submit"/>
       ...
       $('.add_student_body .add_student_cover').click(function(){
		...
		$("#myModal").modal();
		  ...
		  $('#sname_list').on('change', function() {
			 ...
			 var get_place = $('.intro .sposition').val();	
...
jQuery(document).ready(function($)
{
	 ...
	 $('.stud_submit').click(function(){ 
	    ...
	    if(stuid !='')	{
            ...
            $.ajax({
                url: '<?php echo site_url('teacher/class_layout_change/'); ?>' + lid + '/' + stuid + '/'+ place,
