<form class="" action="<?php echo site_url('teacher/group_message/create_group') ?>" method="post">
    ...
    <table  class="table table-bordered table-striped">
      ...
      <?php 
		foreach ($user_list as $user):
			...
			if($school_id != $this->session->userdata('school_id')) continue;
	  ?>
        <tr>
          <td><input type="checkbox" class="<?php echo $user_array[$i]; ?>" name="user[]" value="<?php echo $user_array[$i].'_'.$user[$user_array[$i].'_id']; ?>"></td>
		  <td>
		  <?php 
