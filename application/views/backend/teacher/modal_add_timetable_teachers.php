	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/createtimetable_teachers/'.$teacher.'/'.$term.'/'.$year), array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'id'=>'form' ));?>
            
            <div class="padded">


                <input type="hidden" class="form-control" name="teacher" id="teacher" value="<?php echo $teacher; ?>" /> 
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Tr.(Selected)</label>
                    <div class="col-sm-5">
                        <input readonly type="text" class="form-control" name="tvenue" value="<?php  echo $this->db->get_where('teacher' , array('teacher_id' => $teacher))->row()->name; ?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"/>
                    </div>
                </div>
