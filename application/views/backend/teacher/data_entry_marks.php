                ...
                $.each(respData.content, function(i, item) {
                    ...
                    if(item.subsubject.length > 0){
                        ...
                        $.each(item.subsubject, function(i, subjitem) {                          
                           ...
                           marksbox += '<div class="btn-group">'+item.subsubjectname[i]+'<input onKeyPress="" class="marksinput" style="text-align:center;float:right;width:30%;" type="text" id="'+subjitem+'_marks_'+item.student_id+'" name="'+subjitem+'_marks_'+item.student_id+'" value='+item.subsubjectmark[i]+' ></div>';
                         ...
                         marksbox +=  '<div class="btn-group"><b>'+item.subject+' TOTAL</b><input readonly class="marksinput"  style="background:#135564;color:white;font-weight:bold;border:thick; text-align:center;float:right;width:30%;" type="text" id="marks_'+item.student_id+'" name="marks_'+item.student_id+'" value='+item.marks+'></div>';
