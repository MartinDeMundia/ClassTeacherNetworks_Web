		...
		<?php echo form_open(site_url('admin/marks_update/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id));?>
			<table class="table table-bordered">
				<thead>
					<tr>
						<th width="100">#</th>
						<th width="100"><?php echo get_phrase('id');?></th>
						<th width="400"><?php echo get_phrase('name');?></th>
						<th width="300"><?php echo get_phrase('marks_obtained');?></th>
						<th width="300"><?php echo get_phrase('comment');?></th>
					</tr>
				</thead>
				<tbody>
				...
				?>
					<tr>
                        ...
                        <td width="100"><?php echo $this->db->get_where('student',array('student_id'=>$row['student_id']))->row()->student_code;?></td>
						...
						<td>
							...
							jQuery(document).ready(function(){
								//jQuery('#total1').focus(function(){
									jQuery(document).on('click focus', '#total23_<?php echo $row['mark_id'];?>', function(e) {
						...
						<?php } elseif ($parts == '3') { ?>
							...
							jQuery(document).ready(function(){
								//jQuery('#total1').focus(function(){
									jQuery(document).on('click focus', '#total24_<?php echo $row['mark_id'];?>', function(e) {
									var item11 = $('#mark_obtained1_<?php echo $row['mark_id'];?>').val();
									var item22 = $('#mark_obtained2_<?php echo $row['mark_id'];?>').val();
									var item33 = $('#mark_obtained3_<?php echo $row['mark_id'];?>').val();
						...
						<?php } elseif ($parts == '4') { ?>
							...
							jQuery(document).ready(function(){
								//jQuery('#total1').focus(function(){
									jQuery(document).on('click focus', 'total25_<?php echo $row['mark_id'];?>', function(e) {
									var item11 = $('#mark_obtained1_<?php echo $row['mark_id'];?>').val();
									var item22 = $('#mark_obtained2_<?php echo $row['mark_id'];?>').val();
									var item33 = $('#mark_obtained3_<?php echo $row['mark_id'];?>').val();
