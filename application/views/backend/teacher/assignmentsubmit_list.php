...
<tbody>
    ...
    $assignments = $this->db->get_where('assignments', array('user_id' => $login_user_id,'role_id' =>2))->result_array();
            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <!-- EDITING LINK -->
                        <li>
                            <a href="<?php echo site_url('teacher/assignmentsubmit_edit/'.$row['assignment_id']);?>">
