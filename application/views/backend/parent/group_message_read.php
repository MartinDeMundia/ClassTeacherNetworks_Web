...
<div class="mail-wrapper" style="overflow-y: auto;">
  <?php
...
<?php echo form_open(site_url('parents/group_message/send_reply/'. $current_message_thread_code) , array('enctype' => 'multipart/form-data')); ?>
