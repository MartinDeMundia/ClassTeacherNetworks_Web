	...
	<div class="col-md-12">
			<table class="table table-bordered">
				...
				<tbody>
					...
					/*$running_year = '2018-2019'; //$this->db->get_where('settings' , array('type' => 'running_year'))->row()->description;	
					$class_id = '24'; //$this->uri->segment(4);
					$section_id = '51'; //$this->uri->segment(6);
					$exam_id = '34'; //$this->uri->segment(5);*/
					
					$running_year = '2018-2019'; //$this->db->get_where('settings' , array('type' => 'running_year'))->row()->description.'</br>';	
