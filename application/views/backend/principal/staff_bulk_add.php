<hr />
<?php echo form_open(site_url('admin/bulk_staff_add_using_csv/import') ,
	...
	<div class="col-md-12" style="padding: 10px; background-color: #B3E5FC; color: #424242;">
		<p style="font-weight: 700; font-size: 15px;">
			...
			<ol>
				...
				<li style="padding: 5px;"><?php echo get_phrase('open_the_downloaded_').'"bulk_staffs.csv" File. ';?></li>
				<li style="padding: 5px;"><?php echo get_phrase('save_the_edited_').'"bulk_staffs.csv" File.';?></li>
...
<a href="" download="bulk_staffs.csv" style="display: none;" id = "bulk">Download</a>
...
jQuery(document).ready(function($) {
	...
	$("#generate_csv").click(function(){
		...
		$.ajax({
			url: '<?php echo site_url('admin/generate_bulk_staff_csv');?>',
