...
<?php
  ...
  function fetchtimetablelesson($year,$term,$class_id,$section_id,$day,$starttime,$endtime){
       ...
       $dbsettings =  $ci->db->get_where('timetable_settings', array(
        ...
        $lessonbox = "<span style='font-size:8px;font-weight:900;'>".substr( $lesson, 0, 4)."".$lessoncode."</span>";
        
        
        $displayString = '<div style="width:40px;height:78px;"> <div style="color:brown;font-size:1.4em;">'.$lessonbox.'</div>
