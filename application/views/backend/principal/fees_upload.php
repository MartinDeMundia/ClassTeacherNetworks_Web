<hr />
<?php echo form_open(site_url('admin/import_fees_csv/import') ,
...
<div class="row">
	<div class="col-md-12" style="padding: 10px; background-color: #B3E5FC; color: #424242;">
		<p style="font-weight: 700; font-size: 15px;">
			<?php echo get_phrase('please_follow_the_instructions_for_import_fees:'); ?>
		</p>
			<ol>
				<li style="padding: 5px;"><?php echo get_phrase('at_first').'" Make sure & Invoice prepare for term fees".'; ?></li>
				<li style="padding: 5px;"><?php echo "Generate CSV File"; ?></li>
				<li style="padding: 5px;"><?php echo get_phrase('open_the_downloaded_').'"fees.csv" File. ';?></li>
				<li style="padding: 5px;"><?php echo get_phrase('save_the_edited_').'"fees.csv" File.';?></li>
...
<a href="" download="fees.csv" style="display: none;" id = "bulk">Download</a>
...
jQuery(document).ready(function($) {
	...
	$("#generate_csv").click(function(){
		...
		$.ajax({
			url: '<?php echo site_url('admin/generate_fees_csv');?>',
