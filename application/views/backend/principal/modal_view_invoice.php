        ...
        <table width="100%" border="0">
            <tr>
                <td align="right">
                    ...
                    <h5><?php echo get_phrase('status'); ?> : <?php echo ($row['due'] == 0)?'Paid':'Pending'; ?></h5>
                </td>
            </tr>
        </table>
        <hr>
            ...
            <tr>
                ...
                <td align="right" valign="top">
                    ...
                    <?php 
                        ...
                        echo get_phrase('class') . ' ' . $this->db->get_where('class', array('class_id' => $enroll->class_id))->row()->name;
						echo "<br>".get_phrase('section') . ' ' . $this->db->get_where('section', array('section_id' => $enroll->section_id))->row()->name;
                    ?><br>
                </td>
            </tr>
        </table>
