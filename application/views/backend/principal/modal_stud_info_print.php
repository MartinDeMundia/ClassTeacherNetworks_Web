...
<div class="row" id="notice_print">
    <div class="col-md-12">
        ...
        <div class="tab-content">
                ...
                <table border="1px" class="table table-bordered datatable ">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo $this->crud_model->get_image_url('student',$row1['student_id']);?>" class="img-circle" width="30" /></td>
