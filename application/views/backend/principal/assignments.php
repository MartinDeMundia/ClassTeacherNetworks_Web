        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(site_url('principal/assignments/create') , array(
					...
					<div class="form-group">
					<label class="col-sm-3 control-label">Attach assignment file (Excel/PDF/Word)</label>
					  <div class="col-sm-5">
					  
					  
	                    <input type="file" name="userfile" class="form-control file2 inline btn btn-info" data-label="<i class='entypo-tag'></i> Select assignment file to attach"
