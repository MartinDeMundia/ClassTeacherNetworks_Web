  ...
  function student_profile($student_id)
  {
	...
	function behaviour_update($stuid){
		...
		foreach($behaviours as $k => $behaviour){
			...
			if($cnt >0){
				...
				//$this->db->update('behaviour_reports' , array('report' =>$report,'action'=>$action,'others'=>$others));
    ...
    function manage_timetable($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_timetable_info') {
			...
			$data['lunch_duration']       = $this->input->post('lunch_duration');
			$data['school_id']       = $this->session->userdata('school_id');
			$data['break_between_period']       = $this->input->post('break_between_period');
			$data['lunch_between_period']       = $this->input->post('lunch_between_period');
