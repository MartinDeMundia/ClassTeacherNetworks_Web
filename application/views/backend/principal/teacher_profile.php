...
<?php
  ...
  $subject_info = $this->db->get_where('subject', array('teacher_id' => $teacher_id, 'year' => $running_year))->result_array();
...
<div class="profile-env">
	<header class="row">
		<div class="col-md-3">
			<center>
        <a href="#">
  				<img src="<?php echo $this->crud_model->get_image_url('teacher', $teacher_id) ;?>" class="img-circle"
          style="width: 60%;" />
  			</a>
        <br>
        <h3>
    ...
    <div class="col-md-9">
		...
		<ul class="nav nav-tabs">
			<li class="active"><a href="#tab1" data-toggle="tab" class="btn btn-default">
					...
					<span class="hidden-xs"><?php echo get_phrase('Classes'); ?></span>
				</a>
			</li>			 			
		</ul>
