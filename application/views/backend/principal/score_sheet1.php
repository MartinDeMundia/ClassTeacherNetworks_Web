<div class="btn-group" style="float:right;" >
	...
	?>
		<li>
			<a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/modal_score_sheet/'.$class_idp.'/'.$exam_id.'/'.$section_id);?>');">
			<i class="entypo-pencil"></i>
			<?php echo get_phrase('print_score_sheet');?>
			</a>
...
<div class="row">
	<div class="col-md-12">
		<?php echo form_open(site_url('admin/score_sheet'));?>
			<div class="col-md-3">
			...
			<button type="submit" id='submit' class="btn btn-info"><?php echo get_phrase('View Score Sheet');?></button>
		...
		<table class="table table-bordered">
			...
			?>
				...
				<?php
					...
					$new_subject_id = $this->db->get_where('subject' , array('subject_id' => $row2['subject_id']))->row()->class_subject;
				?>
					<td style="text-align: center;">
						<?php 
