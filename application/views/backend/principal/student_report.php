                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                        <a class="report" target="_blank" href="<?php echo site_url('admin/s_report/edit/'.$row['student_id']);?>">
                                        ...
                                        <li>
                                        <a class="report" target="_blank" href="<?php echo site_url('admin/s_report/view/'.$row['student_id']);?>">
                                        <i class="entypo-user"></i>
