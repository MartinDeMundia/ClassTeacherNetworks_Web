		...
		<div class="icon"><i class="entypo-docs"></i></div>
			...
			<h3 style="color: #696969;">
				<?php					
					...
					print('MARK BOOK REPORT FOR '.$subject_name);
				?>
			</h3>			
...
//echo $content ; exit();
    ...
    $pdf->SetTitle('MARK BOOK STUDENT '.strtoupper($form." ". $stream. " ".$en." ". $subject." ($term - ". $year. ")"));  
    $pdf->SetHeaderData('MARK BOOK REPORT DETAILED  '.strtoupper($form." ". $stream. " ".$en." ". $subject." ($term - ". $year. ")").date('M/d/Y'), '', PDF_HEADER_TITLE, PDF_HEADER_STRING);  
