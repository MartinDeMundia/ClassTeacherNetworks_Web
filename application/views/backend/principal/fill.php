		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                            ...
                            <div class="form-group hidden" style="margin-bottom: 15px;">
                                    <select placeholder="Select exam..." class="form-control"  id="examst" ><option value="0">Select <?php echo $school_id; ?>...</option>
                                  <?php
								 
								 
								  $q="SELECT term1 from exams where school_id='".$school_id."'";
							...
							<form method="POST" enctype="multipart/form-data" class="form-inline" role="form" id="ef">
							 ...
							 <div class="form-group" style="margin-bottom: 15px;">
                                  ...
                                  <option value="t">Select <?php echo $school_id; ?>...</option>
								 ...
								 $q="SELECT Abbreviation from subjects where school_id='".$school_id."'";
								  $r=$this->db->query($q)->result_array();;
								 foreach($r as $row) :
									 ?>
								...
								<?php
                                   $q="SELECT * from form where school_id='".$school_id."'";
								  $r=$this->db->query($q)->result_array();;
								 foreach ($r as $row) :
									 ?>
								...
								<?php
                                   $q="SELECT * from streams where school_id='".$school_id."'";
								  $r=$this->db->query($q)->result_array();;
								 foreach ($r as $row) :
									 ?>
                                    <option value="<?php echo $row['Name']; ?>"><?php echo $row['Name']; ?></option>
