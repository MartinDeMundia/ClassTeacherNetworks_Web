                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
										...
										<li>
                                            <a target="_blank" href="<?php $report =5; echo site_url('admin/academic_report_summery/'.$row['student_id'].'/'.$report);?>">
										...
										<li>
                                            <a target="_blank" href="<?php $report =5; echo site_url('admin/academic_report_detail/'.$row['student_id'].'/'.$report);?>">
                                                <i class="entypo-user"></i>
