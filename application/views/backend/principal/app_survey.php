...
<div class="row">
    <div class="col-md-12">
				...
				$questions = $this->db->get_where("survey",array('school_id'=>$school_id))->result_array();
				$i=0;
				foreach($questions as $quiz):
				$i+=1;
				if($quiz['target'] == $user_id || $quiz['target']==3){
				...
				?>
								 ...
								 <tr>
								<td><a href="<?php echo base_url(); ?>index.php/admin/survey/take/<?php echo $quiz['id']; ?>/<?php echo $user_id; ?>"><?php echo $quiz['title']; ?></a>
								 </td>
			...
			<button id="comlete" class="btn btn-info">Save</div>
