			...
			<h3 style="color: #696969;">
				<?php					
					 ...
					 if($class_id == "all"){
                         ...
                         //$class_name = $this->db->get_where('class' , array('class_id' => $class))->row()->name;
                         $class_name = $this->db->get_where('section' , array('section_id' => $section_id))->row()->name;
                         $class_name = intval($class_name );	
                         $section_name = "All";
					 }else{
			...
			<table class="table" style="width:100%" width="100%">
				<thead>
					...
					?>
						...
						<th style="background-color:grey;color:white;font-weight:900;padding:10px;width:25%;">Teacher</th>
					</tr>
				</thead>
				<tbody>
					...
					foreach($subjects as $row):
					   ...
					   $total_num=0;
						...
						<td><?php
						 ...
						 ?></td>
						<td style="width:25%;"><?php echo $row['teacher'];?></td>
					</tr>
					<?php endforeach;?>						
