<div class="btn-group" style="float:right;" >
	...
	?>
		<li>
			<a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/modal_blank_broad_sheet/'.$class_id.'/'.$exam_id.'/'.$section_id);?>');">
...
<div class="row">
	<div class="col-md-12">
		<?php echo form_open(site_url('admin/tabulation_sheet_blank'));?>
			<div class="col-md-4">
