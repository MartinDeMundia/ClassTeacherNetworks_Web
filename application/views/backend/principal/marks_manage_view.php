...
<div class="row" style="text-align: center;">
	...
	<div class="col-sm-4">
		<div class="tile-stats tile-gray">
			...
			<h4 style="color: #696969;">
				<?php echo get_phrase('total_marks_out_of');?> : <?php echo $this->db->get_where('class_subjects' , array('id' => $subject_id))->row()->total_marks_out_of;?>
			</h4>
		</div>
	</div>
	<div class="col-sm-4"></div>
					...
					<tr>
						...
						<td>
							<div class="col-lg-12">
								...
								<input type="text" class="form-control totalmark" id="total23_<?php echo $row['mark_id'];?>" name="total1" value="" /> 
								</div>
							</div>	
							...
							jQuery(document).ready(function(){
								//jQuery('#total1').focus(function(){
									jQuery(document).on('click focus blur', '#mark_obtained1_<?php echo $row['mark_id'];?>,#mark_obtained2_<?php echo $row['mark_id'];?>', function(e) {
									...
									if(!isNaN(total1)){
										jQuery("#total23_<?php echo $row['mark_id'];?>").val(total1);
									}
						...
						<?php } elseif ($parts == '3') { ?>
							...
							<div class="col-lg-12">
								...
								<input type="text" class="form-control totalmark" id="total24_<?php echo $row['mark_id'];?>" name="total2" value="" /> 
								</div>
							</div>
							<script type="text/javascript">
								var BASE_URL = "<?php echo base_url();?>";
							...
							jQuery(document).ready(function(){
								//jQuery('#total1').focus(function(){
									jQuery(document).on('click focus blur', '#mark_obtained1_<?php echo $row['mark_id'];?>,#mark_obtained2_<?php echo $row['mark_id'];?>,#mark_obtained3_<?php echo $row['mark_id'];?>', function(e) {
									var item11 = $('#mark_obtained1_<?php echo $row['mark_id'];?>').val();
									var item22 = $('#mark_obtained2_<?php echo $row['mark_id'];?>').val();
									var item33 = $('#mark_obtained3_<?php echo $row['mark_id'];?>').val();
									var total2 = parseInt(item11) + parseInt(item22) + parseInt(item33);
									jQuery("#total24_<?php echo $row['mark_id'];?>").val(total2);
									if(!isNaN(total2)){
										jQuery("#total24_<?php echo $row['mark_id'];?>").val(total2);
									}
									var settings = {
						...
						<?php } elseif ($parts == '4') { ?>
							...
							<div class="col-lg-12">
								...
								<input type="text" class="form-control totalmark" id="#total25_<?php echo $row['mark_id'];?>" name="total3" value="" /> 
								</div>
							</div>	
							<script type="text/javascript">
								var BASE_URL = "<?php echo base_url();?>";
							...
							jQuery(document).ready(function(){
								//jQuery('#total1').focus(function(){
									jQuery(document).on('click focus blur', '#mark_obtained1_<?php echo $row['mark_id'];?>,#mark_obtained2_<?php echo $row['mark_id'];?>,#mark_obtained3_<?php echo $row['mark_id'];?>,#mark_obtained4_<?php echo $row['mark_id'];?>', function(e) {
									var item11 = $('#mark_obtained1_<?php echo $row['mark_id'];?>').val();
									var item22 = $('#mark_obtained2_<?php echo $row['mark_id'];?>').val();
									var item33 = $('#mark_obtained3_<?php echo $row['mark_id'];?>').val();
									var item44 = $('#mark_obtained4_<?php echo $row['mark_id'];?>').val();
									var total3 = parseInt(item11) + parseInt(item22) + parseInt(item33)+ parseInt(item44);
									jQuery("#total25_<?php echo $row['mark_id'];?>").val(total3);
									if(!isNaN(total3)){
										jQuery("#total25_<?php echo $row['mark_id'];?>").val(total1);
									}
									var settings = {
									  "async": true,
									  "crossDomain": true,
						...
						<script type="text/javascript">
							...
							jQuery(document).ready(function(){
									...
									jQuery(document).on('click focus blur change', '.input_mark', function(e) {
									...
									var settings = {
									  ...
									  "data": {
										...
										"class_id": $('#marks_obtained_<?php echo $row['class_id'];?>').val(),
										"section_id": $('#marks_obtained_<?php echo $row['section_id'];?>').val(),
										"mark_id": $('#marks_obtained_<?php echo $row['mark_id'];?>').val(),										
									  }
									}
						...
						<input tabindex="0" type="text" class="form-control" name="comment_<?php echo $row['mark_id'];?>"
