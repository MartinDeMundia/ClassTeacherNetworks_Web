	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(site_url('principal/teacher/do_update/'.$row['teacher_id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('tsc_number');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="tsc_number" value="<?php echo $row['tsc_number'];?>" data-validate="required"/>
                                </div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="role" value="<?php echo $row['designation'];?>" data-validate="required"/>
                                </div>
                            </div>
