		...
		<div class="icon"><i class="entypo-docs"></i></div>
			<h3 style="color: #696969;">
				<?php
					...
					echo get_phrase('broad sheet');
				?>
			</h3>
			<h4 style="color: #696969;">
				<?php echo get_phrase('stream') . ' ' . $class_name. ' ' . $section_name;?> : <?php echo $exam_name;?>
			</h4>
		</div>
	</div>
	<div class="col-md-4"></div>
...
<div class="row">
	<div class="col-md-12">
		<div style="float:right; margin: 0px 0 15px 0;">
		...
		<table class="table table-bordered">
			...
			?>
				...
				<?php
					$total_marks = 0;
					$total_grade_point = 0;  
					$new_exam_id2 =  $this->uri->segment('4');					
					...
					<td style="text-align: center;">
						<?php 
							$obtained_mark_query = 	$this->db->get_where('mark' , array(
													'class_id' => $class_id , 
														'exam_id' => $new_exam_id2 , 
															'subject_id' => $row2['class_subject'] , 
