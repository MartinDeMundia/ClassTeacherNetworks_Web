				...
				<ul class="dropdown-menu <?php if ($text_align == 'right-to-left') echo 'pull-right'; else echo 'pull-left';?>">
					<li>
						<a href="<?php echo site_url($account_type . '/manage_profile');?>">
							...
							<span><?php echo get_phrase('edit_profile/password');?></span>
						</a>
					</li>
					<?php if ($account_type == 'principal'):?>
					<li>
						<a href="<?php echo site_url('principal/principal_profile/'.$this->session->userdata('login_user_id'));?>">
                        	<i class="entypo-key"></i>
							<span><?php echo get_phrase('my_classes');?></span>
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('principal/principal_table/'.$this->session->userdata('login_user_id'));?>">
                        	<i class="entypo-key"></i>
