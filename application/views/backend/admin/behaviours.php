        ...
        <br>
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
					<?php $behaviours12 = $this->db->get('behaviours')->result_array();?>
                    	<?php $count = 1;foreach($behaviours12 as $row):?>
                        <tr>
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <li>
									 ...
									 <li class="divider"></li>
		                                    ...
		                                    <!-- DELETION LINK -->
		                             <li>
		                                 <a href="#" onclick="confirm_modal('<?php echo site_url('admin/behaviours/delete/'.$row['id']);?>');">
