<div class="row">
	<div class="col-md-12">
      ...
      <?php echo form_open(site_url('admin/principal/create/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<!--div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="password" value="" data-validate="required">
						</div>
					</div-->					 
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo get_phrase('add_principal');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
