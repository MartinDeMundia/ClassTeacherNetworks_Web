...
class PHPJasperXML {
    ...
    public function connect($db_host,$db_user,$db_pass,$db_or_dsn_name,$cndriver="mysqli") {
		    $db_host="localhost";
            $db_or_dsn_name="appsclassteacher";
            $db_user="appsuserclass";
            $db_pass=">UKn}6=MK[w^`P5B";
    ...
    $this->cndriver=$cndriver;
        if($cndriver=="mysqli") {
            ...
            if(!$this->con) {
                ...
                if($this->myconn) {
                    $seldb = @mysqli_select_db($this->myconn,$db_or_dsn_name);
    ...
    public function disconnect($cndriver="mysqli") {
        if($cndriver=="mysqli") {
            if($this->con) {
                if(@mysqli_close()) {
                    $this->con = false;
...
//        $b=$data->subreportParameter;
    ...
    public function transferDBtoArray($host,$user,$password,$db_or_dsn_name,$cndriver="mysqli") {
        $this->m=0;
...
//echo "$pchartfolder/class/pData.class.php";die;
    ...
    $result = @mysqli_query($this->myconn,$sql); //query from db
    $chartdata=array();
    $i=0;
//echo $sql."<br/><br/>";
    $seriesname=array();
...
/*       $rowheight="";
   ...
   $this->pdf->writeHTML($table);
    ...
    public function query($sql){
        ...
        return @mysqli_query($this->myconn,$sql);
    }
