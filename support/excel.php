...
include 'simplexlsx.class.php';
			...
			$xlsx = new SimpleXLSX('uploads/data_upload.xlsx');
			...
			foreach( $xlsx->rows() as $r ) 
			{
				...
				$query="select * from sudtls WHERE adm='$r[0]' ";
...
$code=$r[2];
$Stream=$r[1];;
	$qs="SELECT Abbreviation  FROM subjects where code='$code'";
$results=mysqli_query($con,$qs);
while($rs=mysqli_fetch_assoc($results)){
	
	$subject=$rs['Abbreviation'];
}
$score1=0;
$score2=0;
$limit1=0;
...
$subtr="";
$tb="scores";
$exm=strtoupper(str_replace("-","",str_replace(" ","",mysqli_real_escape_string($con,$_POST['exam']))));
