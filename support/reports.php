                ...
                <div class="ibox " id="ibox2">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a id="rvfpt" href="../PDFS/items.pdf" download="<?php echo strtoupper($_SESSION['subject']."-".$_SESSION['category']."-".$_SESSION['class'].'-'.$_SESSION['param']. '-items' ) ?>">
...
<div class="sk-spinner sk-spinner-wave">
                    ...
                    <tbody>
					<?php 
					$q="SELECT serial,isbn,title,form,category,subject,status,id from books where 1=1  $serial  $isbn $title $author $category $subject $param";
					//echo $q;
					$result=$con->query($q);
